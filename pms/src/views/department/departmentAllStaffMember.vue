...
export default{
     ...
     mounted() {
      ...
      if(!token){
       this.$router.push({name:'Login'})
         ...
         axios.get(`http://localhost:5000/List/1/staff_member/department_id/${this.$route.params.departmentId}/''/1/first_name`)
               .then(response => {
        ...
        axios.get(`http://localhost:5000/listLength/staff_member/department_id/${this.$route.params.departmentId}/''/1`)
         .then(response => {
    ...
    async  getPage(page){
         ...
         await axios.get(`http://localhost:5000/List/${this.page}/staff_member/department_id/${this.$route.params.departmentId}/''/1/first_name`)
               .then(response => {
                  this.names = response.data[0]; 
                  console.log(this.pages)
                    })
    ...
    async  backPage(page){
          ...
          if(this.page < (this.pages +1) && this.page>1){
           ...
           await axios.get(`http://localhost:5000/List/${this.page}/staff_member/department_id/${this.$route.params.departmentId}/''/''/first_name`)
            .then(response => {
              this.names = response.data[0];
    ...
    async  fetchData(){
        await axios.get(`http://localhost:5000/search/staff_member/department_id/${this.$route.params.departmentId}/''/''/first_name/second_name/${this.search}`)
         .then(response => {
         this.names=response.data[0];
           console.log(this.pages)
         })
