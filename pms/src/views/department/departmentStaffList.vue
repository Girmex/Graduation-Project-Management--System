<template>
  ...
  <div class="w-full mx-4" v-if="this.names.length!==0">
                    ...
                    <tbody>
                      <tr class="border-b"  v-for="item in this.names " :key="item.id">
                        ...
                        <td class="text-sm text-blue-500 font-light whitespace-nowrap ">
                          <router-link class="p-1 rounded-md bg-blue-700 text-white hover:bg-blue-500" :to="{name:'departmentStaffMemberInfo',params:{id:item.id,departmentId:item.department_id}}" >See More</router-link>
                        </td>
                       </tr>
  ...
  export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
           ...
           axios.get(`http://localhost:5000/List/1/staff_member/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/staff_member/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/List/${this.page}/staff_member/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
                    this.names = response.data[1]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
          await axios.get(`http://localhost:5000/search/staff_member/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/first_name/second_name/${this.search}`)
           .then(response => {
           this.names=response.data[1];
             console.log(this.pages)
           })
