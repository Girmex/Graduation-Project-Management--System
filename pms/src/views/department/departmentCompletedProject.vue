<template>
                    ...
                    <tbody>
                      <tr class="border-b"  v-for="item in this.names " :key="item.id">
                        ...
                        <td class="text-sm font-light whitespace-nowrap text-right ">
                          ...
                          <RouterLink class="p-2 rounded-md pr-3 bg-blue-700 text-white hover:bg-blue-500" :to="{name:'departmentProjectInfo',params:{departmentId:this.$route.params.departmentId,id:item.id}}">See More</RouterLink>
                        </td>
                       </tr>
  ...
  export default{
    ...
    let dat = new Date();
        ...
        console.log(dat)
    axios.get(`http://localhost:5000/BestProjectNumber/department_id/${this.$route.params.departmentId}/${this.year}`)
           .then(response => {
           ...
           axios.get(`http://localhost:5000/ListProject/1/allproject/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/id`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/allproject/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/ListProject/${this.page}/allproject/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/id`)
                 .then(response => {
                    this.names = response.data[1]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
        await axios.get(`http://localhost:5000/searchProject/allproject/department_id/${this.$route.params.departmentId}/${this.$route.params.type}/${this.$route.params.value}/title/advisor/${this.search}`)
           .then(response => {
           this.names=response.data[1];
             console.log(this.pages)
           })
      ...
      async uploadProject(id,tab) {       
       ...
       this.$router.push({name:'departmentAllProject',params:{departmentId:this.$route.params.departmentId}})   
       } 
       catch (err) {
         console.log(err);
       }
