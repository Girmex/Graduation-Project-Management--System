    ...
    <div class="font-serif bg-gray-900 lg:flex p-3 my-20 mx-10 rounded-md text-white items-center justify-center w-full ">
      ...
      <div class="text-left">
        ...
        <li v-if="isPassword">
          ...
          <li v-if="isPhone">
            Phone Number:
            <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" maxlength="10" v-model="phone" required placeholder="Enter your new Phone number"
  ...
  methods: {
    ...
    async updatePassword() {
      ...
      if (this.password == '') {
        ...
        try {
          await axios.put(`http://localhost:5000/updateProfile/${id}`, {
    ...
    async updatePhone() {
      ...
      if (this.phone == '') {
        ...
        try {
          await axios.put(`http://localhost:5000/updateStaffUserProfile/${id}`, {
            // username: this.username,
            type: "phone_number",
            value: this.phone
          })
