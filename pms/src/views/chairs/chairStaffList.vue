  ...
  export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
           ...
           axios.get(`http://localhost:5000/List/1/staff_member/chair_id/${this.$route.params.chairId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/staff_member/chair_id/${this.$route.params.chairId}/${this.$route.params.type}/${this.$route.params.value}`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/List/${this.page}/staff_member/chair_id/${this.$route.params.chairId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
                    this.names = response.data[1]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
          await axios.get(`http://localhost:5000/search/staff_member/chair_id/${this.$route.params.chairId}/${this.$route.params.type}/${this.$route.params.value}/first_name/second_name/${this.search}`)
           .then(response => {
           this.names=response.data[1];
             console.log(this.pages)
           })
