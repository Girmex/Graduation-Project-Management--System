  ...
  export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
           ...
           axios.get(`http://localhost:5000/List/1/allproject/chair_id/${this.$route.params.chairId}/''/''/id`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/allproject/chair_id/${this.$route.params.chairId}/''/''`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/List/${this.page}/allproject/chair_id/${this.$route.params.chairId}/''/''/id`)
                 .then(response => {
                    this.names = response.data[0]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
        await axios.get(`http://localhost:5000/searchProject/allproject/chair_id/${this.$route.params.chairId}/chair_id/1/title/advisor/${this.search}`)
           .then(response => {
           this.names=response.data[0];
