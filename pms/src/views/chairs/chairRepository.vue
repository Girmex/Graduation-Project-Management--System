...
<template>
  <div class="container font-serif mx-auto py-8">
    <form @submit="handleSubmit"
      class="max-w-full mx-20  bg-white border border-gray-700 shadow-md rounded px-8 pt-6 pb-8 mb-4">
      <div class="max-w-full  lg:flex mr-3 ">

        <div class="w-full lg:w-1/2 mr-4">
          <div class="flex mb-3">
            <label class="label py-1">Date:</label>
            <input type="date" v-model="date" required class="py-1" />
          </div>
          <div class="flex mb-2">
          ...
          <div class=" my-3 ">
            <div class="field text-left  ">
              ...
              <div class="control">
                <div class="control">
                  <input class="w-full border  border-blue-500 rounded py-1 placeholder:px-2" v-model="student1"
                    placeholder="please insert student1" required>
                </div>
              </div>
            </div>
            <div class="field text-left  ">
              ...
              <div class="control">
                <div class="control">
                  <input class="w-full border  border-blue-500 rounded py-1 placeholder:px-2" v-model="student2"
                    placeholder="please insert student2" required>
                </div>
              </div>
            </div>
            <div class="field text-left ">
              ...
              <div class="control">
                <input class="w-full border  border-blue-500 rounded py-1 placeholder:px-2" v-model="student3"
                  placeholder="please insert student3" required>
              </div>
            </div>
            <div class="field text-left ">
              ...
              <div class="control">
                <div class="control">
                  <input class="w-full border  border-blue-500 rounded py-1 placeholder:px-2" v-model="student4"
                    placeholder="please insert student4" required>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w-full lg:w-1/2">
          <div class="my-2">
            <div class="lg:flex">
              ...
              <label for="file1"
                class="bg-blue-500 hover:bg-blue-700 text-white ml-6 font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline cursor-pointer">
          ...
          <div class="mb-2">
            <div class="lg:flex">
              ...
              <label for="file2"
                class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-2 ml-6 rounded focus:outline-none focus:shadow-outline cursor-pointer">
...
export default {
  ...
  mounted() {
    ...
    this.chair_id = localStorage.getItem('chair_id')
    console.log(this.chair_id)
  ...
  methods: {
    ...
    handleSubmit(event) {
      ...
      axios.post('http://localhost:5000/repoChair', formData)
        .then(response => {
