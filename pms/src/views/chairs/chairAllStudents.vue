                      ...
                      <tbody>
                        <tr class="border-b"  v-for="item in names " :key="item.id">
                          ...
                          <td class="text-sm text-blue-500 font-light whitespace-nowrap ">
                           ...
                           <button @click="deleteStudent(item.id)" class="ml-7 p-1 rounded-md bg-red-700 text-white hover:bg-red-500">delete</button>
    ...
    export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
             ...
             axios.get(`http://localhost:5000/List/1/students/chair_id/${this.$route.params.chairId}/''/1/first_name`)
                   .then(response => {
            ...
            axios.get(`http://localhost:5000/listLength/students/chair_id/${this.$route.params.chairId}/''/1`)
             .then(response => {
        ...
        async  getPage(page){
             ...
             await axios.get(`http://localhost:5000/List/${this.page}/students/chair_id/${this.$route.params.chairId}/''/1/first_name`)
                   .then(response => {
                      this.names = response.data[0]; 
                      console.log(this.pages)
                        })
        ...
        async  backPage(page){
              ...
              if(this.page < (this.pages +1) && this.page>1){
               ...
               await axios.get(`http://localhost:5000/List/${this.page}/students/chair_id/${this.$route.params.chairId}/''/''/first_name`)
                .then(response => {
                  this.names = response.data[0];
        ...
        async  fetchData(){
            await axios.get(`http://localhost:5000/search/students/chair_id/${this.$route.params.chairId}/''/''/first_name/second_name/${this.search}`)
             .then(response => {
             this.names=response.data[0];
               console.log(this.pages)
             })
