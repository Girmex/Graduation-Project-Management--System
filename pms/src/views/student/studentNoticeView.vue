<template>
    <div class="font-serif flex flex-col my-6 items-center mx-3 ">
        <div v-for="notice in notices" :key="notice.id" class="lg:w-2/3 h-full border border-gray-700 rounded-md bg-white text-black">
  ...
  export default {
    ...
    async mounted(){
        ...
        console.log(faculty);
       await axios.get(`http://localhost:5000/notice_detail/${this.$route.params.notice}/${faculty}/student/all`)
          .then(response => {
