                      ...
                      <tbody>
                        <tr class="border-b"  v-for="item in this.names " :key="item.id">
                          ...
                          <td class="text-sm text-center font-light whitespace-nowrap ">
                             <RouterLink class="p-1 rounded-md bg-blue-700 text-white hover:bg-blue-500" :to="{ name: 'studentProjectDetail', params: { id: this.$route.params.id, group: item.id } }">See More</RouterLink>
                          </td>
                         </tr>
