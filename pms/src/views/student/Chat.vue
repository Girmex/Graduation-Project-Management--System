<template>
  ...
  <div v-for="item in this.history " :key="item.id" class="bg-gray-300 w-full border border-blue-600 rounded-md">
    <p class=" font-extrabold text-cyan-800 font-sans"> Computer Engineering Project Chat </p>
    <router-link :to="{ name: 'ChatDetail', params: { id: this.$route.params.id, group:this.$route.params.group} }">
