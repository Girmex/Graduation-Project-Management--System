    ...
    <div class="absolute right-2">
        ...
        <div :class="divStyle">
            ...
            <ul class="text-left  pt-2">
              <li class="pl-8 py-1 bg-gray-300 hover:bg-gray-500 hover:text-white"><RouterLink :to="{name:'allStudents' ,params:{facultyId:this.$route.params.facultyId}}"><span :class="mainlistStyle">All Students</span></RouterLink></li>                
              <li class="pl-8 py-1 bg-gray-200 hover:bg-gray-500 hover:text-white"><RouterLink :to="{name:'studentsList', params:{facultyId:this.$route.params.facultyId,type:'year(students.date) !',value:2023}}">Graduated Students</RouterLink></li>
              <li class="pl-8 py-1 bg-gray-300 hover:bg-gray-500 hover:text-white"><RouterLink :to="{name:'studentsList', params:{facultyId:this.$route.params.facultyId,type:'year(students.date) ',value:2023}}">Under Graduate Students</RouterLink></li>
        ...
        <div :class="divStyle" >
            ...
            <ul class="text-left  pt-2">
                ...
                <li v-for="item in this.department " :key="item.department_id"  class="pl-8 py-1 bg-gray-300 hover:bg-gray-500 hover:text-white">
                     <RouterLink :to="{name:'studentsList', params:{facultyId:this.$route.params.facultyId,type:'students.department_id',value:item.department_id}}">{{ item.department_name }}</RouterLink>
                </li>
        ...
        <div :class="divStyle" >
              ...
              <ul class="text-left  pt-2">
                  ...
                  <li v-for="chair in this.chairs " :key="chair.id"  class="pl-8 py-1 bg-gray-300 hover:bg-gray-500 hover:text-white">
                     <RouterLink :to="{name:'studentsList', params:{facultyId:this.$route.params.facultyId,type:'students.chair_id',value:chair.id}}">{{ chair.name }}</RouterLink>
                  </li>
