<template>
  ...
  export default{
    ...
    axios.get(`http://localhost:5000/ListProject/1/allproject/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/id`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/allproject/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/ListProject/${this.page}/allproject/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/id`)
                 .then(response => {
                    this.names = response.data[1]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
        await axios.get(`http://localhost:5000/searchProject/allproject/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/title/advisor/${this.search}`)
           .then(response => {
           this.names=response.data[1];
             console.log(this.pages)
           })
