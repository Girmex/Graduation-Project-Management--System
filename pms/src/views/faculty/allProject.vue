  ...
  export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
           ...
           axios.get(`http://localhost:5000/List/1/allproject/faculty_id/${this.$route.params.facultyId}/''/''/id`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/allproject/faculty_id/${this.$route.params.facultyId}/''/''`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/List/${this.page}/allproject/faculty_id/${this.$route.params.facultyId}/''/''/id`)
                 .then(response => {
                    this.names = response.data[0]; 
                    console.log(this.pages)
                      })
         ...
         this.page=this.pages
           await axios.get(`http://localhost:5000/List/${this.page}/allproject/faculty_id/${this.$route.params.facultyId}//''/id`)
             ...
             .catch(error => console.log(error))
               ...
               async  fetchData(){
        await axios.get(`http://localhost:5000/searchProject/allproject/faculty_id/${this.$route.params.facultyId}/faculty_id/1/title/advisor/${this.search}`)
           .then(response => {
           this.names=response.data[0];
