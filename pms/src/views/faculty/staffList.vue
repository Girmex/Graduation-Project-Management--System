                    ...
                    <tbody>
                      <tr class="border-b"  v-for="item in this.names " :key="item.names_id">
                        ...
                        <td class="text-sm  font-light whitespace-nowrap ">
                          <router-link class="p-1 rounded-md bg-blue-700 text-white hover:bg-blue-500" :to="{name:'staffMemberInfo',params:{id:item.id,facultyId:this.$route.params.facultyId}}" >See More</router-link>
                        </td>
                       </tr>
  ...
  export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
           ...
           axios.get(`http://localhost:5000/staffList/1/staff_member/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
          ...
          axios.get(`http://localhost:5000/listLength/staff_member/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}`)
           .then(response => {
      ...
      async  getPage(page){
           ...
           await axios.get(`http://localhost:5000/staffList/${this.page}/staff_member/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/first_name`)
                 .then(response => {
                    this.names = response.data[2]; 
                    console.log(this.pages)
                      })
      ...
      async  fetchData(){
          await axios.get(`http://localhost:5000/searchStaff/staff_member/faculty_id/${this.$route.params.facultyId}/${this.$route.params.type}/${this.$route.params.value}/first_name/second_name/${this.search}`)
           .then(response => {
           this.names=response.data[2];
             console.log(this.pages)
           })
