        ...
        <tbody>
          <tr class="border-b" v-for="item in this.names " :key="item.id">
            ...
            <td class="text-sm text-blue-500 font-light whitespace-nowrap ">
              <RouterLink :to="{ name: 'adminProjectInfo', params: { id: item.id } }">view</RouterLink>
            </td>
          </tr>
...
export default {
  ...
  mounted() {
    ...
    axios.get(`http://localhost:5000/ListProject/1/allproject/${this.$route.params.type}/${this.$route.params.value}/faculty_id/1/id`)
      .then(response => {
    ...
    axios.get(`http://localhost:5000/adminListProjectLength/allproject/${this.$route.params.type}/${this.$route.params.value}`)
      .then(response => {
  ...
  methods: {
    async getPage(page) {
      ...
      await axios.get(`http://localhost:5000/ListProject/${this.page}/allproject/${this.$route.params.type}/${this.$route.params.value}/faculty_id/1/id`)
        .then(response => {
          this.names = response.data[0];
          console.log(this.pages)
        })
    ...
    async fetchData() {
      await axios.get(`http://localhost:5000/searchProject/allproject/${this.$route.params.type}/${this.$route.params.value}/faculty_id/1/title/advisor/${this.search}`)
        .then(response => {
          this.names = response.data[0];
          console.log(this.pages)
        })
