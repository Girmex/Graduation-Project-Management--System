...
export default{
     ...
     mounted() {
      ...
      if(!token){
       this.$router.push({name:'Login'})
         ...
         axios.get(`http://localhost:5000/staffList/1/staff_member/faculty_id/1/faculty_id/1/first_name`)
               .then(response => {
                  this.names = response.data[3]; 
        ...
        axios.get(`http://localhost:5000/adminListLength/staff_member/faculty_id/''`)
         .then(response => {
    ...
    async  getPage(page){
         ...
         await axios.get(`http://localhost:5000/staffList/${this.page}/staff_member/faculty_id/1/faculty_id/1/first_name`)
               .then(response => {
                  this.names = response.data[3]; 
                  console.log(this.pages)
                    })
    ...
    async  fetchData(){
        await axios.get(`http://localhost:5000/searchStaff/staff_member/faculty_id/1/position/1/first_name/id/${this.search}`)
         .then(response => {
         this.names=response.data[3];
           console.log(this.pages)
         })
