    ...
    export default{
      ...
      if(!token){
       this.$router.push({name:'Login'})
             ...
             axios.get(`http://localhost:5000/ListStudent/1/students/position/1/faculty_id/''/first_name`)
                   .then(response => {
            ...
            axios.get(`http://localhost:5000/adminListLength/students/faculty_id/1`)
             .then(response => {
        ...
        async  getPage(page){
             ...
             await axios.get(`http://localhost:5000/ListStudent/${this.page}/students/position/1/faculty_id/''/first_name`)
                   .then(response => {
                      this.names = response.data[3]; 
                      console.log(this.pages)
                        })
        ...
        async  fetchData(){
            await axios.get(`http://localhost:5000/searchStudent/students/students.faculty_id/1/students.faculty_id/''/first_name/id/${this.search}`)
             .then(response => {
