<template>
    <div class="font-serif flex flex-col my-6 items-center mx-3 ">
      ...
      <div class="flex  field text-left ml-4 mt-3 ">
      ...
      <div class="flex field text-left mr-4 mt-3">
        <div class="mr-2"><label class="label py-4">For:</label></div>
        <div class="control">
            <select v-model="status" name="dropdown">
      ...
      <div class="h-1/2 field text-left ml-4 ">
        ...
        <div class="control h-full mr-4">
            <textarea v-model="body" class="w-full h-full flex justify-center items-center border rounded-md" placeholder="Enter notice body"></textarea>
        </div>
        </div>
    
      <div class="mt-10">
        <button class="button is-success w-1/2 h-8 my-3 border rounded-md bg-blue-800 text-white" @click="sendNotice()">Send</button>
      </div>
    </div>
    </div>
  </template>
