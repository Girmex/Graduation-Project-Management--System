  ...
  mounted() {
      ...
      if(!token){
       this.$router.push({name:'Login'})
             ...
             axios.get(`http://localhost:5000/ListStudent/1/students/${this.$route.params.type}/${this.$route.params.value}/id/''/first_name`)
                   .then(response => {
            ...
            axios.get(`http://localhost:5000/adminListLength/students/${this.$route.params.type}/${this.$route.params.value}`)
             .then(response => {
        ...
        async  getPage(page){
             ...
             await axios.get(`http://localhost:5000/ListStudent/${this.page}/students/${this.$route.params.type}/${this.$route.params.value}/id/''/first_name`)
                   .then(response => {
                      this.names = response.data[4]; 
                      console.log(this.pages)
                        })
        ...
        async  fetchData(){
            await axios.get(`http://localhost:5000/searchStudent/students/${this.$route.params.type}/${this.$route.params.value}/first_name/''/first_name/id/${this.search}`)
             .then(response => {
